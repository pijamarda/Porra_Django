...
urlpatterns = [
    ...
    url(r'^user/(?P<pk>[0-9]+)/$', views.partido_list, name='partido_list'),
    #url(r'^user/(?P<pk>[0-9]+)/edit/$', views.partido_edit),
    url(r'^user/(?P<pk_user>[0-9]+)/partido/(?P<pk>[0-9]+)/$', views.partido_detalle, name='partido_detalle'),
    ...
    url(r'^user/(?P<pk_user>[0-9]+)/grupo/(?P<pk_grupo_id>[0-9]+)/$', views.grupo_equipos, name='grupo_equipos'),  
    url(r'^user/(?P<pk_user>[0-9]+)/grupo/3rd/$', views.grupo_3rd, name='grupo_3rd'),  
